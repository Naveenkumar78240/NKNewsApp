            ...
            <footer className="professional-footer">
                <div className="footer-content">
                    <div className="footer-section about">
                        <h3>About NK News</h3>
                        <p>NK News brings you the latest trending news from around the world. Stay informed and updated with us.</p>
                    </div>
                    ...
                    <div className="footer-section contact">
                        <h3>Contact Us</h3>
                        <p>Email: contact@nknews.com</p>
                        <p>Phone: +91 7824022263</p>
                    </div>
                ...
                <div className="footer-bottom">
                    <p>&copy; 2025 NK News. All Rights Reserved.</p>
                </div>
            </footer>
        </div>
    );
